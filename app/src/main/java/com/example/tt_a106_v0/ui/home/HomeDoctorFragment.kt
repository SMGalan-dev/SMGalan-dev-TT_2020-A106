...
import com.example.tt_a106_v0.databinding.FragmentHomeDoctorBinding

class HomeDoctorFragment : Fragment() {

    private lateinit var homeDoctorViewModel: HomeDoctorViewModel
    ...
    override fun onCreateView(
        ...
        homeDoctorViewModel = ViewModelProvider(this).get(HomeDoctorViewModel::class.java)
        _binding = FragmentHomeDoctorBinding.inflate(inflater, container, false)
        val root: View = binding.root
        /* val textView: TextView = binding.textHome
         homeDoctorViewModel.text.observe(viewLifecycleOwner, Observer {
           textView.text = it
         })*/
        return root
    }
