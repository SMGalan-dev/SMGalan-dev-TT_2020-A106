...
import com.example.tt_a106_v0.MainActivityDoctor
import com.example.tt_a106_v0.MainActivityPatient1
import com.example.tt_a106_v0.R
import com.google.firebase.firestore.FirebaseFirestore
import java.util.*

class EndRegisterDoc : AppCompatActivity() {

    private val db = FirebaseFirestore.getInstance()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_end_register_doc)
    ...
    private fun dataPatientReg(typeUser: String, genre: String, email:String){
        ...
        val cedula = findViewById<EditText>(R.id.editTextCedula)
        ...
        if (nameText.text.isNotEmpty() && apPText.text.isNotEmpty() && apMText.text.isNotEmpty() && phoneReg.text.isNotEmpty()){
            ...
            Log.d("Cedula" , cedula.text.toString())
