...
class GlucometerFragment : AppCompatActivity() {
    ...
    private fun checkLocationServices(): Boolean {
        ...
        return if (!areLocationServicesEnabled()) {
            AlertDialog.Builder(this@GlucometerFragment)
                    ...
                    .setMessage("Se requieren los permisos de ubicación para buscar el dispositivo bluetooth") // Want to enable?
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        ...
        if (allGranted) {
            ...
            AlertDialog.Builder(this@GlucometerFragment)
                    .setTitle("Se requieren los permisos de ubicación para buscar el dispositivo")
